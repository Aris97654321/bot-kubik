...
read -p "Masukan DeviceCode Android Anda :" dc
read -p "Masukan Tk Android Anda :" tk
read -p "Masukan Token Android Anda :" token
read -p "Masukan UUID Device Anda :" uuid
read -p "Masukan Sign Kubik Anda :" sign
read -p "Masukan Android ID Anda :" id

##############################################################################################################
$config['deviceCode'] 		= '$dc';
$config['tk'] 				= '$tk';
$config['token'] 			= '$token';
$config['uuid'] 			= '$uuid';
$config['sign'] 			= '$sign';
$config['android_id'] 		= '$id';
##############################################################################################################
